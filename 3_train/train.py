...
from cnn_impl.head.metrics import ArcFace, CosFace, SphereFace, Am_softmax
from cnn_impl.loss.focal import FocalLoss
from cnn_impl.util.utils import make_weights_for_balanced_classes, get_val_data, separate_irse_bn_paras, separate_resnet_bn_paras, warm_up_lr, schedule_lr, perform_val, get_time, buffer_val, AverageMeter, accuracy
...
if __name__ == '__main__':
    ...
    DISP_FREQ = 1 if DISP_FREQ==0 else DISP_FREQ
